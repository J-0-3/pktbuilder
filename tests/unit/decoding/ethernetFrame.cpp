...
int main() {
    std::vector<uint8_t> frameData({
        0x54,0xa0,0x50,0x6f,0xa9,0x10,0x04,0x7b,0xcb,0xb5,0xf3,0x50,0x08,0x00,0x45,0x00,
    ...
    assert(frame.getDestinationMac() == pktbuilder::mac_addr_t({0x54, 0xa0, 0x50, 0x6f, 0xa9, 0x10}));
    assert(frame.getSourceMac() == pktbuilder::mac_addr_t({0x04, 0x7b, 0xcb, 0xb5, 0xf3, 0x50}));
