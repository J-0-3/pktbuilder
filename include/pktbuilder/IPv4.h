...
namespace pktbuilder {
    enum class IPv4ProtocolNumber: uint8_t {
        HOPOPT = 0,
        ICMP = 1,
        IGMP = 2,
        GGP = 3,
    ...
    class IPv4Packet: public IntermediaryLayer {
        ...
        uint8_t ttl{};
        IPv4ProtocolNumber protocol = IPv4ProtocolNumber::HOPOPT;
        std::vector<IPv4Option> options;
    public:
        IPv4Packet() = default;
        IPv4Packet(ipv4_addr_t source_ip, ipv4_addr_t destination_ip,
        ...
        ipv4_addr_t const& getSourceAddress() const;
        ipv4_addr_t const& getDestinationAddress() const;
    };
}